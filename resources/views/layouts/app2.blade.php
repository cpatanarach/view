...
<head>
    ...
    <!-- Animate.css -->
    <link rel="stylesheet" href="{{url('/resources/assets/learn/learn/css/animate.css')}}">
    <!-- Icomoon Icon Fonts-->
    <link rel="stylesheet" href="{{url('/resources/assets/learn/learn/css/icomoon.css')}}">
    <!-- Bootstrap  -->
    <link rel="stylesheet" href="{{url('/resources/assets/learn/learn/css/bootstrap.css')}}">

    <!-- Magnific Popup -->
    <link rel="stylesheet" href="{{url('/resources/assets/learn/learn/css/magnific-popup.css')}}">

    <!-- Owl Carousel  -->
    <link rel="stylesheet" href="{{url('/resources/assets/learn/learn/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{url('/resources/assets/learn/learn/css/owl.theme.default.min.css')}}">

    <!-- Theme style  -->
    <link rel="stylesheet" href="{{url('/resources/assets/learn/learn/css/style.css')}}">

    <!-- Modernizr JS -->
    <script src="{{url('/resources/assets/learn/learn/js/modernizr-2.6.2.min.js')}}"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
...
<body>
                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="display-t">
                        <div class="display-tc animate-box" data-animate-effect="fadeIn">
                            <h1>ฝ่ายปฏิบัติการคอมพิวเตอร์</h1>
                            <h2>สำนักเทคโนโลยีสารสนเทศ กรมที่ดิน <a href="http://freehtml5.co/" target="_blank">freehtml5.co</a></h2>
    ...
    <!-- jQuery -->
    <script src="{{url('/resources/assets/learn/learn/js/jquery.min.js')}}"></script>
    <!-- jQuery Easing -->
    <script src="{{url('/resources/assets/learn/learn/js/jquery.easing.1.3.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{url('/resources/assets/learn/learn/js/bootstrap.min.js')}}"></script>
    <!-- Waypoints -->
    <script src="{{url('/resources/assets/learn/learn/js/jquery.waypoints.min.js')}}"></script>
    <!-- Stellar Parallax -->
    <script src="{{url('/resources/assets/learn/learn/js/jquery.stellar.min.js')}}"></script>
    <!-- Carousel -->
    <script src="{{url('/resources/assets/learn/learn/js/owl.carousel.min.js')}}"></script>
    <!-- countTo -->
    <script src="{{url('/resources/assets/learn/learn/js/jquery.countTo.js')}}"></script>
    <!-- Magnific Popup -->
    <script src="{{url('/resources/assets/learn/learn/js/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{url('/resources/assets/learn/learn/js/magnific-popup-options.js')}}"></script>
    <!-- Main -->
    <script src="{{url('/resources/assets/learn/learn/js/main.js')}}"></script>
    @yield('script')
</body>
</html>
